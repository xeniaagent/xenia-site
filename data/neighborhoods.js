...
window.NEIGHBORHOODS = {
  castro_upper_market: {
    ...
    vibe: {
      ...
      schools: {"elementary": ["Harvey Milk Civil Rights Academy (TK-5, 4235 19th St)", "Sanchez Elementary (TK-5, 325 Sanchez St)", "McKinley Elementary"], "middle": ["Everett Middle School (6-8)"], "high": ["Mission High School (9-12, 18th and Dolores)"]},
  ...
  noe_valley: {
    ...
    vibe: {
      ...
      schools: {"elementary": ["Alvarado Elementary (K-5, 625 Douglass St, southern edge)"], "middle": ["James Lick Middle (1220 Noe St, in neighborhood)", "Everett Middle (450 Church, Castro edge)"], "high": []},
  ...
  west_portal: {
    ...
    vibe: {
      ...
      schools: {"elementary": ["West Portal Elementary (K-5, Ulloa Street)"], "middle": ["Aptos Middle (West of Twin Peaks)"], "high": ["Ruth Asawa SOTA (performing-arts magnet)", "Lowell (exam-based)"]},
